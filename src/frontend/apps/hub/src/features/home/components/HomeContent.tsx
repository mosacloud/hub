                    ...
                    >
                      <Text as="p" $display="inline" $variation="secondary">
                        <Trans
                          ...
                          defaults="LaSuite Hub is the entry point to La Suite collaborative tools. It is built on top of <0>Django Rest Framework</0> and <1>Next.js</1>."
                          components={[
                            <a
                      ...
                      <Text as="p" $display="inline">
                        <Trans
                          ...
                          defaults="You can easily self-host LaSuite Hub (check our installation <0>documentation</0>). Today it centralizes access to services, and tomorrow it will also help manage account information.<2/>LaSuite Hub uses an innovation and business friendly <1>licence</1> (MIT)."
                          components={[
                            <a
                              key="documentation"
                              href="https://github.com/suitenumerique/hub/"
                              target="_blank"
                            />,
                            <a
                              key="licence"
                              href="https://github.com/suitenumerique/hub/blob/main/LICENSE"
                              target="_blank"
                            />,
                            <br key="line-break" />,
                          ]}
