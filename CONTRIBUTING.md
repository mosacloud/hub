...
To get started with the project, please refer to the [README.md](https://github.com/suitenumerique/hub/blob/main/README.md) for detailed instructions on how to run LaSuite Hub locally.
...
We use a [GitHub Project](https://github.com/orgs/suitenumerique/projects) (need update: no project created for now) in order to prioritize our workload.
